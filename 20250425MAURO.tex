...
%	\sf\footnotesize\setlength\tabcolsep{4pt}
%	\centering
%	\begin{tabular}{l | c | c | S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0] | S[table-format=4.0] | S[table-format=4.0] }
%		\toprule
...
\begin{quote}
El 10 de noviembre de 1976, después de haber arrancado las acciones a Lidia Papeleo de Graiver, los directivos de \emph{La Razón}, \emph{La Nación} y \emph{Clarín} dieron una \enquote{conferencia de prensa} en la sede de la Asociación de Entidades Periodísticas Argentinas (\textsc{adepa}), \textbf{esa nefasta asociación de lobby que sobrevive para vergüenza de la libertad de expresión}.\footnote{El énfasis es propio.}
\end{quote}
...
\begin{quote}
Luego, con la salida de Carlos Menem del poder retomó ciertos rasgos de independencia informativa, sobre todo durante el Gobierno de Fernando de la Rúa (Bargach y Suárez, 2014: 35)\footnote{La cita se refiere a \textsc{telam}}.
\end{quote}
