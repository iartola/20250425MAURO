...
\begin{table}[!ht]
	\sf\footnotesize\setlength\tabcolsep{4pt}
	\centering
	\begin{tabular}{l | c | c | S[table-format=3.0]| S[table-format=3.0]| S[table-format=3.0]| S[table-format=3.0]| S[table-format=3.0]| S[table-format=3.0]| S[table-format=3.0] | S[table-format=3.0] | S[table-format=3.0] }
		\toprule
